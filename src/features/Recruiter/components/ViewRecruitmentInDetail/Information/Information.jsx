...
function Information({ recruitment }) {
  return (
    <Box className="content-containerSt">
      <Box className="content-containerSt__benefits-container">
        <Typography color="primary" variant="h5">
          Benefits
        </Typography>
        <Box className="content-containerSt__benefits-container__wrapper">
          <Box className="content-containerSt__benefits-container__wrapper__benefits-details">
            <Box className="margin-content">
              {recruitment.benefits.split("\n").map((i, key) => {
                return (
                  <Box
                    key={key}
                    className="content-containerSt__benefits-container__wrapper__benefits-details__content"
                  >
          ...
          <Box className="content-containerSt__benefits-container__wrapper__other-info">
            <Box className="boxInfo">
              <Box className="content-containerSt__benefits-container__wrapper__other-info__content-line">
                <img
